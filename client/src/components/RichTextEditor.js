...
class RichTextEditor extends Component {
  ...
  constructor(props) {
    ...
    this.onChange = editorState =>
      this.setState({ editorState }, this.handleOnChangeHTML(editorState))
  }
  ...
  _initializeEditorState() {
    ...
    if (!isLoaded && valueString.length > 0) {
      this.setState(
        { isLoaded: true },
        this.onChange(this.pushEditorStateWithHtml(valueString, editorState))
      )
    }
  }
      ...
      <div className={classNames("RichEditor-root", this.props.className)}>
        ...
        >
          <Editor
            ...
            spellCheck
          />
          <LegacyCopyPasteInput
            handlePastedHTML={(text, html) =>
